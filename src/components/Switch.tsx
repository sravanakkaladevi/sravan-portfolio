...
// UIverse integrated component: Interactive Switch/Download button
const Switch = ({ href }) => {
  const handleChange = (e) => {
    if (e.target.checked && href) {
      // Open in a new tab immediately to bypass popup blocker
...
const StyledWrapper = styled.div`
  ...
  .label {
    ...
    border: 2px solid ${({ theme }) => theme.primary}bb;
    display: flex;
    align-items: center;
    border-radius: 50px;
    width: 160px;
  ...
  .label:hover {
    ...
    box-shadow: 0 8px 24px ${({ theme }) => theme.primary}40, 0 0 15px ${({ theme }) => theme.primary}1a;
  }
